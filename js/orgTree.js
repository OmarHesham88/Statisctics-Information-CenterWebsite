...
// Start Main Box Node 
OrgChart.templates.itTemplate.node = '<rect class="main-node" filter="url(#cool-shadow)"  x="0" y="0" height="120" width="220" fill="#ffffff"  rx="10" ry="10" style="position:relative" ></rect><rect class="bottom-node"  x="0" y="110" width="220" fill="#F5F6FA" rx="3" ry="3" height="30"></rect>';
// chart box img 
...
// create Table 
OrgChart.templates.itTemplate.field_1 = '<g data-bs-toggle="modal" data-bs-target="#createTable" ><rect style="overflow:hidden;"  x="70" y="108" width="120" height="30" fill="none" stroke-width="1" stroke="" text-anchor="end"></rect>'+'<image preserveAspectRatio="xMidYMid " clip-path="url(#{createId})" href="./images/create-table.png" x="190" y="116"  width="18" height="19" style="cursor: pointer;"></image><text class="create-text" style="font-size: 12px;font-family:Din-Text;cursor: pointer;z-index=-1;" fill="#7B7890" width="120" height="30" x="185" y="130" text-anchor="end" data-width="90"  data-text-overflow="ellipsis">{val}</text></g>';

// create Dep 
// create Dep 
OrgChart.templates.itTemplate.field_2 = '<g class="createDep"><rect style="overflow:hidden;"  x="70" y="108" width="120" height="30" fill="none" stroke-width="1" stroke="" text-anchor="end"></rect>'+ '<text class="dep-name" style="font-size: 12px;font-family:Din-Text;cursor: pointer;z-index=-1;" fill="#7B7890" width="120" height="30" x="185" y="130" text-anchor="end" data-width="90"  data-text-overflow="ellipsis">{val}</text></g>';
// create Dep img
OrgChart.templates.itTemplate.field_Depimg = '<g class="createDep"><rect  x="120" y="110" width="100" height="30" fill="none" stroke-width="1" stroke=""></rect>'+'<clipPath id="{depId}"><rect   stroke-width="0" x="190" y="116" rx="0" ry="0" width="18" height="19" ></rect></clipPath><image preserveAspectRatio="xMidYMid " clip-path="url(#{depId})" xlink:href="{val}" x="190" y="116"  width="18" height="19" style="cursor: pointer;"></image></g>'
// edit box 
...
chart.load([
    { id: 1, name: "  استمارة ربعية"   , title: "انشاء جدول", img: "./images/file-document-orange.png",edit :'./images/pencil-outline.png', delete: './images/trash-can-outline.png', view:'./images/eye-outline.png' },
    { id: 2, name: "  استمارة سنوية"   , title: "انشاء جدول", img: "./images/file-document-outline.png", edit :'./images/pencil-outline.png', delete: './images/trash-can-outline.png', view:'./images/eye-outline.png' },
    ...
    { id: 10, pid:9 , name: "الى اخرين غير مقيمين"   , img: "",createDep: "  " , edit :'./images/pencil-outline.png', delete: './images/trash-can-outline.png', askQa:'' },
    { id: 11, pid:9 , name: "الى مستثمر مباشر من أطراف تابعة"  , img: "",createTable:'', edit :'./images/pencil-outline.png', delete: './images/trash-can-outline.png', askQa:'' },
...
chart.on('redraw', function () {
    ...
    chart.on('redraw', function () {
        var createText = document.querySelectorAll('.create-text');    
        for (var i=0; i < createText.length; i++) {
            if(createText[i].innerHTML === "undefined"){
                createText[i].classList.add('hide')
            }
        }
...
//         var boxes = document.querySelectorAll(".createDep");
